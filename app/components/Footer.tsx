        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="h-8 w-8 mr-2 bg-primary-800 rounded-full flex items-center justify-center">
                <span className="text-white font-bold text-lg">P</span>
              </div>
              <span className="font-bold text-lg">PsyGamingLab</span>
            </div>
            <p className="text-neutral-400 text-sm mb-4">
              {lang === 'en'
                ? 'Innovative therapeutic and gamified experiences for mental health and wellbeing.'
                : 'Innovative therapeutische und spielerische Erfahrungen für psychische Gesundheit und Wohlbefinden.'}
            </p>
          ...
          {/* Games */}
          <div>
            <h3 className="font-bold text-lg mb-4">{t('ourGames')}</h3>
            <ul className="space-y-2">
              {gameIds.map((gameId) => (
                <li key={gameId}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-2 text-neutral-400">
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2 mt-0.5 text-neutral-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <a href="mailto:felixwulf7@gmail.com" className="hover:text-white transition-colors">
